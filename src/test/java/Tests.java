...
public class Tests {
    ...
    public void validate_login_excel(){
        ...
        int i = 0;
        while("" != Utility.ReadExcel("saucedemo.xlsx","UserData", i, 0)){
            String userLogin = Utility.ReadExcel("saucedemo.xlsx","UserData", i, 0);
            String userPassword = Utility.ReadExcel("saucedemo.xlsx","UserData", i, 1);
